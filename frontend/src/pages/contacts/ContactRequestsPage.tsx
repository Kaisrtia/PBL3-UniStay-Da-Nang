...
import { FaEnvelope, FaMapMarkerAlt, FaPhoneAlt, FaUniversity, FaUserGraduate } from 'react-icons/fa'
              ...
              <section>
                ...
                <div className='mt-4 grid gap-5'>
                  {receivedRequests.map((request) => (
                    <article key={`${request.postId}-${request.userId}`} className='rounded-2xl bg-white p-5 shadow-lg shadow-[#001D3D]/5'>
                      <div className='grid gap-5 lg:grid-cols-[minmax(0,1fr)_360px]'>
                        ...
                        <div className='rounded-2xl border border-gray-100 p-4'>
                          ...
                          <Link
                            ...
                            className='mt-4 inline-flex rounded-full bg-[#001D3D] px-5 py-2 text-sm font-extrabold text-white transition hover:bg-[#003566]'
                          >
                            Xem bài đăng
                          </Link>
                        </div>
